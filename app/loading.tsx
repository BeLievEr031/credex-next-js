export default function Loading() {
  return (
    <div className="h-screen w-full flex justify-center items-center gap-2">
      <div className="flex gap-[1px] items-center -translate-y-1" data-discover="true">
        <svg width="18" height="19" viewBox="0 0 36 37" fill="none" xmlns="http://www.w3.org/2000/svg" className="mt-2.5">
          <path
        ...
        <p className="text-[#086841] text-[25px] font-semibold font-pp-mori-semibold mt-3">
          credex
        </p>
      </div>
      <div className="h-5 w-px bg-black/20"></div>
      <div className="font-semibold font-pp-mori-semibold">
        <div className="flex items-center justify-center gap-1">
          <div className="w-4 h-4 border-[3px] border-[#086841] border-t-transparent rounded-full animate-spin"></div>
          <p className="font-semibold font-pp-mori-semibold">Loading</p>
        </div>
      </div>
    </div>
  );
