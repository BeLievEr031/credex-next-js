            ...
            <div className="py-5 px-4 md:px-0">
                ...
                <div className="flex md:px-28 gap-x-5 text-[#5B677C] py-4 flex-wrap items-center justify-between ">
                    ...
                    <a href="https://www.linkedin.com/company/credexmarketplace/" target="_blank" className="pt-2 relative z-[10] block">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide cursor-pointer lucide-linkedin-icon lucide-linkedin"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect width="4" height="12" x="2" y="9" /><circle cx="4" cy="4" r="2" /></svg>
                    </a>
                </div>
            </div>
        </footer >
